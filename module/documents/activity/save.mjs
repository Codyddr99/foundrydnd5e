...
export default class SaveActivity extends ActivityMixin(SaveActivityData) {
  ...
  /** @inheritDoc */
  static LOCALIZATION_PREFIXES = [...super.LOCALIZATION_PREFIXES, "DND5R.SAVE"];
  ...
  static metadata = Object.freeze(
    foundry.utils.mergeObject(super.metadata, {
      type: "save",
      img: "systems/dnd5r/icons/svg/activity/save.svg",
      title: "DND5R.SAVE.Title.one",
  ...
  _usageChatButtons(message) {
    ...
    for ( const abilityId of this.save.ability ) {
      const ability = CONFIG.DND5R.abilities[abilityId]?.label ?? "";
      buttons.push({
        label: `
          <span class="visible-dc">${game.i18n.format("DND5R.SavingThrowDC", { dc, ability })}</span>
          <span class="hidden-dc">${game.i18n.format("DND5R.SavePromptTitle", { ability })}</span>
        `,
