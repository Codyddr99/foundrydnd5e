...
export default class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      typeIcon: "systems/dnd5r/icons/svg/hit-points.svg",
      title: game.i18n.localize("DND5R.AdvancementHitPointsTitle"),
      hint: game.i18n.localize("DND5R.AdvancementHitPointsHint"),
      multiLevel: true,
      apps: {
  ...
  /** @inheritDoc */
  get levels() {
    return Array.fromRange(CONFIG.DND5R.maxLevel + 1).slice(1);
  }
  ...
  #getApplicableValue(value) {
    const abilityId = CONFIG.DND5R.defaultAbilities.hitPoints || "con";
