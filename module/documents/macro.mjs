  ...
  switch ( dropData.type ) {
    case "Item":
      ...
      foundry.utils.mergeObject(macroData, {
        name: itemData.name,
        img: itemData.img,
        command: `dnd5r.documents.macro.rollItem("${itemData._source.name}")`,
        flags: {"dnd5r.itemMacro": true}
      });
      break;
    case "ActiveEffect":
      ...
      foundry.utils.mergeObject(macroData, {
        ...
        img: effectData.img,
        command: `dnd5r.documents.macro.toggleEffect("${effectData.name}")`,
        flags: {"dnd5r.effectMacro": true}
      });
      break;
    default:
      return;
