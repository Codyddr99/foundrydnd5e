  ...
  static defineSchema() {
    return {
      items: new ArrayField(new SchemaField({
        ...
        optional: new BooleanField({label: "DND5R.AdvancementItemGrantOptional"})
      }), {required: true, label: "DOCUMENT.Items"}),
      optional: new BooleanField({
        required: true, label: "DND5R.AdvancementItemGrantOptional", hint: "DND5R.AdvancementItemGrantOptionalHint"
      }),
