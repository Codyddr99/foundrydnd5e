  ...
  constructor(options={}, schemaOptions={}) {
    const fields = {
      value: new foundry.data.fields.StringField({
        required: true, blank: true, initial: options.value ?? "", label: "DND5R.Type"
      }),
      subtype: new foundry.data.fields.StringField({
        required: true, blank: true, initial: options.subtype ?? "", label: "DND5R.Subtype"
      }),
      baseItem: new foundry.data.fields.StringField({
        required: true, blank: true, initial: options.baseItem ?? "", label: "DND5R.BaseItem"
      })
    };
