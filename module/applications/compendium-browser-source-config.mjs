 ...
 */
export default class CompendiumBrowserSourceConfig extends Application5e {
  constructor(options) {
    super(options);
  ...
  static DEFAULT_OPTIONS = {
    ...
    actions: {
      clearFilter: CompendiumBrowserSourceConfig.#onClearPackageFilter,
      selectPackage: CompendiumBrowserSourceConfig.#onSelectPackage
    },
    selected: "system"
  };
   ...
   * @this {CompendiumBrowserSourceConfig}
