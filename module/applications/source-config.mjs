...
export default class SourceConfig extends DocumentSheet5e {
  ...
  static PARTS = {
    source: {
      template: "systems/dnd5r/templates/apps/source-config.hbs"
    },
    footer: {
  ...
  /** @override */
  get title() {
    return game.i18n.localize("DND5R.SOURCE.Action.Configure");
  }
  ...
  async _prepareContext(options) {
    ...
    context.rulesVersions = [
      { value: "", label: "" },
      { value: "2024", label: game.i18n.localize("SETTINGS.DND5R.RULESVERSION.Modern") },
      { value: "2014", label: game.i18n.localize("SETTINGS.DND5R.RULESVERSION.Legacy") }
    ];
