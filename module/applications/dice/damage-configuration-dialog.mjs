...
export default class DamageRollConfigurationDialog extends RollConfigurationDialog {
  ...
  async _prepareButtonsContext(context, options) {
    ...
    context.buttons = {
      critical: {
        ...
        label: game.i18n.localize("DND5R.CriticalHit")
      },
      normal: {
        default: !defaultCritical,
        icon: '<i class="fa-solid fa-dice" inert></i>',
        label: game.i18n.localize(allowCritical ? "DND5R.Normal" : "DND5R.Roll")
      }
    };
  ...
  async _prepareFormulasContext(context, options) {
    ...
    const allTypes = foundry.utils.mergeObject(CONFIG.DND5R.damageTypes, CONFIG.DND5R.healingTypes, { inplace: false });
