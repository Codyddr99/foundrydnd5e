...
export default class AttackRollConfigurationDialog extends D20RollConfigurationDialog {
  ...
  async _prepareConfigurationContext(context, options) {
    ...
    const optionsFields = [
      { key: "attackMode", label: "DND5R.ATTACK.Mode.Label", options: this.options.attackModeOptions },
      { key: "ammunition", label: "DND5R.CONSUMABLE.Type.Ammunition.Label", options: this.options.ammunitionOptions },
      { key: "mastery", label: "DND5R.WEAPON.Mastery.Label", options: this.options.masteryOptions }
    ];
    context.fields = [
