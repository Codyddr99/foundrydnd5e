...
export default class CopyableTextElement extends HTMLElement {
  ...
  connectedCallback() {
    ...
    button.ariaLabel = this.getAttribute("label") ?? game.i18n.localize("DND5R.Copy");
  ...
  _onClick(event) {
    ...
    game.tooltip.activate(event.target, { text: game.i18n.format("DND5R.Copied", { value }), direction: "UP" });
  }
}
