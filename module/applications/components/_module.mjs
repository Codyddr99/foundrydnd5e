...
window.customElements.define("dnd5r-checkbox", CheckboxElement);
window.customElements.define("dnd5r-effects", EffectsElement);
window.customElements.define("dnd5r-icon", IconElement);
window.customElements.define("dnd5r-inventory", InventoryElement);
