...
export default class ArmorClassConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/dnd5r/templates/actors/config/armor-class-config.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return game.i18n.localize("DND5R.ArmorClass");
  }
  ...
  async _preparePartContext(partId, context, options) {
    ...
    context.calculationOptions = Object.entries(CONFIG.DND5R.armorClasses).reduce((arr, [value, config]) => {
    ...
    const config = CONFIG.DND5R.armorClasses[context.source.calc];
    context.formula = {
