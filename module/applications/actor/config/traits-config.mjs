...
export default class TraitsConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    traits: {
      template: "systems/dnd5r/templates/actors/config/traits-config.hbs"
    }
  };
   ...
   */
  get otherLabel() {
    return game.i18n.localize("DND5R.ProficiencyOther");
  }
  ...
  _initializeApplicationOptions(options) {
    ...
    if ( !CONFIG.DND5R.traits[options.trait] ) throw new Error(
      `Cannot instantiate TraitsConfig with a trait not defined in CONFIG.DND5R.traits: ${options.trait}.`
    );
  ...
  _processFormData(event, form, formData) {
    ...
    if ( CONFIG.DND5R.traits[this.options.trait].dataType !== Number ) {
